...
class CleanViewTests(TestCase):
    ...
    def setUp(self):
        ...
        # Auth user model for coordinator/responsible_person
        self.AuthUser = get_user_model()
        self.coordinator = self.AuthUser.objects.create_user(
            username="coord",
    ...
    def test_afmeldingslister_with_data(self):
        ...
        afmeldingsliste = Afmeldingsliste.objects.create(
            ...
            afbud="Afbud: John Doe, Jane Smith"
        )
    ...
    def test_append_afbud_success(self):
        ...
        admin = self.AuthUser.objects.create_superuser(
            username="admin", 
        ...
        self.assertIn('updated_afbud', data)
        
        # Verify the name was added
        afmeldingsliste.refresh_from_db()
        self.assertIn('John Doe', (afmeldingsliste.afbud or ''))
    ...
    def test_append_afbud_unauthorized(self):
        ...
        # View returns 200 with error JSON if not authenticated
        self.assertEqual(response.status_code, 200)
    ...
    def test_append_afbud_with_admin(self):
        ...
        # Test non-existent afmeldingsliste returns 200 with success False
        response = self.client.post(
    ...
    def test_select_substitut_ajax(self):
        ...
        # Test successful reservation using current API contract
        response = self.client.post(
            reverse('select_substitut'),
            {
                ...
                'phone': '+45 11111111',
                'pre_arranged': 'on',
                'responsible_email': 'coord@test.com'
            },
            HTTP_X_REQUESTED_WITH='XMLHttpRequest'
        )
