...
class CustomUser(AbstractUser):
    ...
    class Meta:
        ...
        verbose_name_plural = (
            "Substitutter"  # Change the verbose plural name of the model
        )
...
class Substitutliste(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        substitutes_names = ", ".join(
            available_users.values_list("username", flat=True)
        )
    ...
    class Meta:
        ...
        verbose_name_plural = (
            "Substitutlister"  # Change the verbose plural name of the model
        )
...
class Afmeldingsliste(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = (
            "Afmeldingslister"  # Change the verbose plural name of the model
        )
...
class Configuration(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = (
            "Forsidetekst"  # Change the verbose plural name of the model
        )
...
class DayResponsibility(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = (
            "Ansvarlig for dag"  # Change the verbose plural name of the model
        )
